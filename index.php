                    ...
                    {  
                        ...
                        {  
                            ...
                            {  
                                ...
                                <div class="col-md-12"><div style="padding:30px; border:1px solid #CCC;"><audio controls autoplay>
                                <source src="upload/'.$new_name.'" type = "audio/mpeg">
                                </audio><br></div></div>
                                <div class="col-md-12"><div style="padding:30px; border:1px solid #CCC;">
                                <video controls autoplay loop muted width = "400px" height = "400px" poster = "">
    ...
    <html>  
        <head>  
            <title>Extract a Zip File in Php</title>  
        ...
        <body>  
            ...
            <div class="container" style="width:500px;">  
                    <form method="post" enctype="multipart/form-data">  
                        <label>Please choose a zip file</label>  
